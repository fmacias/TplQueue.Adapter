...
This page is now a short navigation hub. The previous all-in-one repository guide was reduced so the tutorial pages can own the consumer documentation without duplicating the same content in several places.
...
- [`API`](https://github.com/fmacias/TplQueue.Adapter/blob/main/src/Fmacias.TplQueue/API.cs)
- [`QFactoryAdapter`](https://github.com/fmacias/TplQueue.Adapter/blob/main/src/Fmacias.TplQueue/Factories/QFactoryAdapter.cs)
- [`ServiceCollectionExtensions.AddTplQueue(...)`](https://github.com/fmacias/TplQueue.Adapter/blob/main/src/Fmacias.TplQueue.Microsoft.DependencyInjection/ServiceCollectionExtensions.cs)
...
- [TplQueue.Core repository docs](https://github.com/fmacias/TplQueue.Core/tree/main/docs/de)
- [fmacias.github.io public TplQueue hub](https://fmacias.github.io/de/tplqueue/)
