...
{
    internal class CoreQFactoryAdapter : ICoreQFactoryAdapter
    {
        private readonly ICoreQFactory _innerFactory;
        ...
        private CoreQFactoryAdapter(
            ICoreQFactory factory,
        ...
        public static CoreQFactoryAdapter Create(
            ICoreQFactory factory,
            IRetryPolicyGenericFactory retryPolicyFactory,
